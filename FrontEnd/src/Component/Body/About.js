...
const About = () => {
  ...
  useEffect(()=>{
    ...
    return (
        <>
            ...
            <section id="sec-features" className="sec-features pt-5 pb-0">
                <div className="container">
  ...
  <div className='d-flex text-center m-5 p-4'>
        {data.map((user=>{
          return(
            <div className="card m-2" style={{ width: "18rem"}} key={user.id}>
              <img className="card-img-top" style={{height:"200px"}} src="https://picsum.photos/200/300" alt="Card image cap" />
